...
public class ScheduleUtils {
     ...
     */
    public static void createScheduleJob(Scheduler scheduler, Task scheduleJob) {
        createScheduleJob(scheduler, scheduleJob.getName(), scheduleJob.getGroup(),
            scheduleJob.getCronTime(), scheduleJob.getSync(), scheduleJob);
    }
     ...
     * @param scheduleJob the schedule job
     */
    public static void updateScheduleJob(Scheduler scheduler, Task scheduleJob) {
